...
public class TextCardHeader3Holder extends BaseTextCardHolder {
    ...
    public TextCardHeader3Holder(Context context, ViewGroup root) {
        super(context, root, R.layout.item_holder_text_card_header3);
